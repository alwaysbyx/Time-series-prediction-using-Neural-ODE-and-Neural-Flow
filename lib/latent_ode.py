...
class LatentODE(VAE_Baseline):
	...
	def get_reconstruction(self, time_steps_to_predict, truth, truth_time_steps, 
		...
		if isinstance(self.encoder_z0, Encoder_z0_ODE_RNN) or \
			...
			#print('first_point_mu', first_point_mu.shape)
		...
		# print('Reconstruction!!!first_point_enc_aug, time_steps_to_predict', first_point_enc_aug.shape, time_steps_to_predict.shape)
		sol_y = self.diffeq_solver(first_point_enc_aug, time_steps_to_predict)
		#print('Shape of sol_y [n_traj_samples, n_samples, n_timepoints, n_latents]', sol_y.shape)
